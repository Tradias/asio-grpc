...
//                           [&]
//                           {
//                               return unifex::then(agrpc::wait(alarm, test::ten_milliseconds_from_now(),
//                               use_sender()),
//                                                   [&](bool)
//                                                   {
//                                                       is_invoked = true;
...
//                                       }};
//     grpc::Alarm alarm;
//     auto op = unifex::connect(agrpc::wait(alarm, test::ten_milliseconds_from_now(),
...
//     auto make_three_requests_then_stop = unifex::then(unifex::sequence(request_sender, request_sender,
//     request_sender),
//                                                       [&]()
//                                                       {
//                                                           stop.request_stop();
...
//     run(unifex::sequence(make_client_unary_request_sender(test::hundred_milliseconds_from_now(),
//     check_status_not_ok),
