...
using ServerUnaryRequest = void (Service::*)(grpc::ServerContext*, Request*, grpc::ServerAsyncResponseWriter<Response>*,
                                             grpc::CompletionQueue*, grpc::ServerCompletionQueue*, void*);

template <class Service, class Request, class Response>
using ServerClientStreamingRequest = void (Service::*)(grpc::ServerContext*,
...
template <class Service, class Request, class Response>
using ServerBidiStreamingRequest = void (Service::*)(grpc::ServerContext*,
