 ...
 * finished. The RequestHandler (or its associated executor [until v2.0.0] / the CompletionToken's completion handler
 * [since v2.0.0]) may also have an associated allocator to control the allocation needed for each request.
 *
